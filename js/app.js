const VERSION = "HYROX MICHEL — STABLE";
...
function exercise(){
  ...
  <div class="nav"><button onclick="prev()">← Préc.</button><button onclick="exercise()">Modifier</button><button onclick="next()">Suivant →</button><button class="danger" onclick="deleteExercise()">Supprimer</button></div>`);
}
